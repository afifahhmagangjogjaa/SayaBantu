        ...
        <aside class="w-64 bg-white shadow-lg fixed h-full flex flex-col z-50">
            ...
            <nav class="p-4 flex-1 overflow-y-auto" id="admin-sidebar-nav">
                ...
                <a href="{{ route('admin.users.index') }}"
                    class="flex items-center mx-3 px-3 py-2.5 mb-2 text-sm font-medium leading-tight {{ request()->routeIs('admin.users.*') ? 'text-white bg-primary-600' : 'text-gray-700 hover:bg-gray-100' }} rounded-lg transition">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
