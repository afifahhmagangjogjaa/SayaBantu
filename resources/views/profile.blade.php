<x-app-layout>
    ...
    <div class="min-h-screen bg-white">
        @php
            ...
            $totalRequests = \App\Models\Help::where('user_id', optional($user)->id)->count();
            $inProgress = \App\Models\Help::where('user_id', optional($user)->id)->where('status', 'memperoleh_mitra')->count();
            $completed = \App\Models\Help::where('user_id', optional($user)->id)->where('status', 'selesai')->count();
        @endphp
        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="px-5 pt-5 pb-32 relative overflow-hidden" style="background: linear-gradient(to bottom right, #0098e7, #0077cc, #0060b0);">
                ...
                <div class="relative z-10">
                    <div class="flex items-center justify-between text-white mb-8">
                        ...
                        <a href="{{ route('profile.edit') }}" class="p-2 hover:bg-white/20 rounded-lg transition">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="text-center avatar-container">
                        <div class="relative inline-block">
                            ...
                            @endphp
                            @if($__avatar)
                                <img src="{{ asset('storage/' . $__avatar) }}" alt="Avatar" class="w-24 h-24 rounded-full object-cover mx-auto ring-4 ring-white/30 shadow-xl">
                            @else
                            ...
                            <button onclick="Livewire.dispatch('openModal')" class="absolute bottom-0 right-0 bg-white p-2 rounded-full shadow-lg hover:scale-110 active:scale-95 transition-transform duration-200">
            ...
            <div class="px-5 -mt-20 relative z-20">
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 stats-card">
                    <div class="grid grid-cols-3 divide-x divide-gray-100">
                        <div class="p-4 text-center group cursor-pointer hover:bg-gray-50 transition-colors duration-200 rounded-l-2xl">
                            <div class="text-2xl font-bold transition-transform duration-300 group-hover:scale-110" style="color: #0098e7;">{{ $totalRequests }}</div>
                        ...
                        <div class="p-4 text-center group cursor-pointer hover:bg-gray-50 transition-colors duration-200">
                            <div class="text-2xl font-bold text-amber-600 transition-transform duration-300 group-hover:scale-110">{{ $inProgress }}</div>
                            <p class="text-xs text-gray-600 mt-1">Diproses</p>
                        </div>
                        <div class="p-4 text-center group cursor-pointer hover:bg-gray-50 transition-colors duration-200 rounded-r-2xl">
                            <div class="text-2xl font-bold text-green-600 transition-transform duration-300 group-hover:scale-110">{{ $completed }}</div>
            ...
            <div class="px-5 pt-6 pb-24">
                    ...
                    <div class="mb-4 p-4 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 shadow-sm flex items-start gap-3.5">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-[11px] text-amber-700 mt-0.5 leading-relaxed">
                                Mohon lengkapi data <span class="font-bold text-amber-900">{{ implode(', ', $missingFields) }}</span> Anda agar dapat mengajukan bantuan.
                            </p>
                            <a href="{{ route('profile.edit') }}" class="inline-flex items-center gap-1 text-xs font-bold text-amber-900 hover:text-amber-950 mt-2 bg-amber-200/80 hover:bg-amber-300 px-3 py-1.5 rounded-lg transition shadow-xs">
                ...
                <div class="space-y-3">
                    ...
                    <!-- Pengaturan -->
                    <a href="{{ route('profile.settings') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex items-center gap-4 hover:shadow-md hover:border-primary-200 transition">
                    ...
                    <!-- Bantuan & Dukungan -->
                    <a href="{{ route('customer.help-support') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex items-center gap-4 hover:shadow-md hover:border-primary-200 transition">
