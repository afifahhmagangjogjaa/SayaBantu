        ...
        <div class="max-w-md mx-auto px-6 -mt-16 relative z-10">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                <div class="mb-4 bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
                    Sesuai dengan kebijakan kami, Anda diwajibkan untuk mengunggah foto KTP dan foto selfie wajah beserta KTP untuk mengakses fitur-fitur krusial di aplikasi ini.
                </div>
