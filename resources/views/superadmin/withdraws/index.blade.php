                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="px-2.5 py-3 text-center whitespace-nowrap">
                                    <button data-id="{{ $item->id }}"
                                        class="open-withdraw-modal inline-flex items-center gap-1 px-2.5 py-1 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 hover:text-primary-600 transition shadow-xs text-xs font-semibold">
                                        Proses
                                    </button>
                                </td>
                            </tr>
