                ...
                <div class="space-y-3">
                    @foreach($notifications as $notification)
                        @php
                            ...
                            if ($type === 'chat_message') {
                            ...
                            } elseif ($type === 'help_status' && ($data['new_status'] ?? '') === 'rejected') {
                                $titleText = '❌ Bantuan Ditolak';
                                $bodyText = $data['message'] ?? 'Permintaan bantuan Anda ditolak oleh admin.';
                                $detailUrl = route('customer.helps.index');
                            } elseif ($type === 'help_taken' || str_contains($type, 'taken')) {
                                ...
                                $statusTitle = match (strtolower($newStatus)) {
                                    ...
                                    'selesai', 'completed' => "🎉 Bantuan Selesai",
