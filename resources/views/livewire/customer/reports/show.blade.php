...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 p-4 pb-32">
        <div class="max-w-2xl mx-auto">
            <div class="mb-6">
                <a href="{{ $report->reported_help_id ? route('customer.chat', ['help' => $report->reported_help_id]) : route('customer.dashboard') }}"
            ...
            <div class="bg-white rounded-2xl shadow-md border {{ $isResolved ? 'border-emerald-200' : ($isRejected ? 'border-red-200' : 'border-gray-200') }} p-6 space-y-4 mb-4">
                ...
                <div class="pt-2">
                    <p class="text-sm font-medium text-gray-700">Mitra yang Dilaporkan</p>
                    <p class="mt-1 text-gray-800 text-sm font-medium">
                ...
                <div class="pt-6 border-t border-gray-100 flex items-center justify-between gap-3">
                    <a href="{{ route('customer.reports.create', ['user_id' => $report->reported_user_id, 'help_id' => $report->reported_help_id, 'new' => 1]) }}" 
